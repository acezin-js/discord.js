...
bot.on('message', message => {
  ...
  try {
    ...
    .setColor('YELLOW')
    .setDescription(`${message.author}, O comando informado nao existe ou ainda nao foi adcionado, se isso for um erro chame por <nome do criador do bot> \nUtilize **.help** para saber meus comandos.`)
...
bot.on('ready', () => {
  ...
  var tabela = [
    { name: 'estou em manutenção bb', type: 'PLAYING' },
    { name: 'ultilize .help para saber meus comandos', type: 'WATCHING' }
  ];
